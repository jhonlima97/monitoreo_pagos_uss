...
{
    public class ConsultasGKN : Integrated.LoadEntity
    {
        ...
        public IList<Object> Get_Listado_ConsultasGKN(String fecha,
                                                    String fechaFin,
                                                    String cUsrCodigo,
                                                    TypeData TypeData = TypeData.gTypeDataReader)
        {
            ...
            {
                SqlDataReader dr = (SqlDataReader)objInsVirt.Get_Listado_ConsultasGKN(fecha, fechaFin, cUsrCodigo);
                IList<Object> lDoc;
